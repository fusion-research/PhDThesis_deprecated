...
\begin{figure*}[t!]
	\begin{center}
		...
		\begin{subfigure}{0.49\textwidth}
			...
			\label{fig:7_7a_awd}
		\end{subfigure}         
    \caption{\textit{Genetic} and \textit{Local Search} optimisation results for metrics of interests (\textit{Hybrid} return policy adopted). \mc{fixare}}
...
%    {
%        \includegraphics[width=0.5\textwidth]{figures/Hybrid_AmountRechargePerc.pdf}
%        \label{fig:7_7a_recharge}
%    }
%
%    \subfloat[][Average state of charge.]
%    {
%        \includegraphics[width=0.5\textwidth]{figures/AvgSOC_comparison.pdf}
%        \label{fig:7_7a_asoc}
%    }     
%
%    \subfloat[][Rerouted trips percentage.]
%    {
%        \includegraphics[width=0.5\textwidth]{figures/Hybrid_ReroutePerc.pdf}
%        \label{fig:7_7a_reroute}
%    } 
%
%    \subfloat[][Walked distance when rerouted.]
%    {
%        \includegraphics[width=0.5\textwidth]{figures/Hybrid_AvgWalkedDistance.pdf}
%        \label{fig:7_7a_awd}
%    }
%
%    \caption{\textit{Genetic} and \textit{Local Search} optimisation results for metrics of interests (\textit{Hybrid} return policy adopted). \mc{fixare}}
