...
% \caption{\tool overview\label{fig:2_framework}}
%\end{figure}
%
%
%
...
%
%
%In this section, we provide a description of \tool. Figure~\ref{fig:2_framework} depicts the architecture of \tool, composed by a first module for the data acquisition, by a second module for data normalization and integration, and then a third  module for the data analysis.
